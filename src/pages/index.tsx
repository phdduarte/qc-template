        ...
        <div className="container">
          <div className="flex">
            <div>
              ...
              <div>
                <span className="badge font-bold">ALERTA DE SPOILER</span>
                <ul className="mt-4">
                  <li>
                    <Image src="/images/check.svg" width={14} height={14} alt="Icon Check" />
                    <span className="ml-2">
                      4 anos de acesso ao novo plano a partir de <b>25/11</b>
                    </span>
                  </li>
                  <li>
                    <Image src="/images/check.svg" width={14} height={14} alt="Icon Check" />
                    <span className="ml-2">
                      Acesso imediato ao <b>Premium Plus</b>
                    </span>
                  </li>
                </ul>
              </div>
                ...
                <div>
                  ...
                  <div className="flex flex items-end">
                    ...
                    <div className="text-center">
                      <h2 className="text-6xl font-extrabold">&nbsp;29,90</h2>
                      <h4 className="font-medium text-xs">ou R$ 299,00 à vista</h4>
                    </div>
                    <div>
                      <Image
                        src="/images/discount_stamp.svg"
                        width={93}
                        height={93}
                        alt="Desconto"
                      />
